...
import * as catalogApi from '../../src/api/useCatalog';
import * as categoriesApi from '../../src/api/useCategories';
import * as enabledSourcesHook from '../../src/hooks/useEnabledSources';
