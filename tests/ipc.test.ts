...
import { tauriApi, type MpvStartOptions } from '../src/api/ipc';
...
describe('typed Tauri IPC wrapper', () => {
  ...
  it.each([
    ...
    ['mpvCommand', [['set', 'panscan', '0']], 'mpv_command', { args: ['set', 'panscan', '0'] }],
    ...
    ['xmltvCacheCommit', ['0123456789abcdef'], 'xmltv_cache_commit', { cacheKey: '0123456789abcdef' }],
