...
vi.mock('../src/services/settingsConfig', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../src/services/settingsConfig')>();
  return {
    ...actual,
...
import { ConfigSettingsSection } from '../src/components/settings/ConfigSettingsSection';
import {
  countChangedSettings,
  saveSettingsConfig,
  selectSettingsConfig,
} from '../src/services/settingsConfig';
import { getSettingsSnapshot, useSettingsStore } from '../src/store/useSettingsStore';
