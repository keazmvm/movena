...
import { clearPlaybackRecovery, readPlaybackRecovery, writePlaybackRecovery } from '../../src/utils/playbackRecovery';
...
describe('playback recovery marker', () => {
  it('round trips safe playback metadata without a stream URL', () => {
    ...
    writePlaybackRecovery({ streamId: '7', title: 'News', type: 'live', currentTime: 2, duration: 0, savedAt: 100 }, storage);
