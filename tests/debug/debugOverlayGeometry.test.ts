...
describe('debug overlay geometry', () => {
  ...
  it('fits dimensions and position inside small viewports', () => {
    expect(fitHudGeometry({ x: -100, y: 900, width: 800, height: 900 }, { width: 420, height: 300 }))
      .toEqual({
  ...
  it('keeps resized geometry inside the right and bottom margins', () => {
    expect(fitHudGeometry({ x: 900, y: 700, width: 500, height: 400 }, { width: 1000, height: 800 }))
