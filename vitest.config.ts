  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/components/m3u-editor/M3uEditor.tsx': { statements: 50, branches: 34, functions: 40, lines: 50 },
        'src/components/m3u-editor/m3uChannelTableModel.ts': { statements: 90, branches: 75, functions: 80, lines: 90 },
        'src/components/common/CrashRecovery.tsx': { statements: 85, branches: 60, functions: 95, lines: 85 },
      },
    },
  },
});
