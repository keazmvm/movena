...
export const Movies = lazy(() =>
  loaders['/movies']().then((module) => ({ default: module.Movies })),
);
export const Series = lazy(() =>
  loaders['/series']().then((module) => ({ default: module.Series })),
);
export const Search = lazy(() =>
  loaders['/search']().then((module) => ({ default: module.Search })),
);
export const Favorites = lazy(() =>
  loaders['/favorites']().then((module) => ({ default: module.Favorites })),
);
export const Collections = lazy(() =>
  loaders['/collections']().then((module) => ({ default: module.Collections })),
);
export const ContinueWatching = lazy(() =>
  loaders['/continue']().then((module) => ({ default: module.ContinueWatching })),
);
export const Downloads = lazy(() =>
  loaders['/downloads']().then((module) => ({ default: module.Downloads })),
);
export const Upcoming = lazy(() =>
  loaders['/upcoming']().then((module) => ({ default: module.Upcoming })),
);
export const Settings = lazy(() =>
  loaders['/settings']().then((module) => ({ default: module.Settings })),
);
