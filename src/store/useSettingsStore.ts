...
import { isUiLanguage, isUiLocale, type UiLanguage, type UiLocale } from '../i18nConfig';
...
export const SETTINGS_SNAPSHOT_KEYS = [
  ...
  'epgSource', 'epgXmltvUrl', 'm3uEditorDensity', 'm3uEditorAutosaveDrafts',
...
export function migrateSettingsState(persistedState: unknown): SettingsState {
  const state = (
    ...
    doviSupport?: unknown;
    playlistInput?: unknown;
    hdrMode?: HdrMode | 'always';
  };
