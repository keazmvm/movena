...
import type { DownloadedItem, DownloadedSeriesGroup } from '../../utils/downloads';
 ...
 * `SeriesDetailModal` here, since that fetches live provider/TMDB data,
...
export function DownloadedSeriesView({ group, onClose }: DownloadedSeriesViewProps) {
  ...
  return (
    <DetailModalShell onClose={onClose} ariaLabel={group.seriesTitle} modalClassName={styles.modal}>
