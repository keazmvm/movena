...
UI work should also run `npm run ui:qa`; visual changes use
`npm run ui:qa:visual`. The feature-gated packaged-desktop journey is built and
run with `npm run desktop:e2e:all`. It verifies the React/Tauri boundary, but
